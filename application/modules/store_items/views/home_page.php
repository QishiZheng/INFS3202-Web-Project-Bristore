...
<!--                                </li>-->
<!--                                <li><a href="#" class="btn btn-outline-light top-btn"> Sign In</a></li>-->
<!--                            </ul>-->
<!--                        </div>-->
<!--                    </nav>-->
<!--                </div>-->
                ...
                <div class="row find-img-align">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="<?php echo base_url(); ?>assets/img/homepage_images/appliances.jpg" class="img-fluid" alt="appliances" />
                                    <figcaption>
                                        <h5>Appliances</h5>
                                        <p>500 Listings</p>
                                    </figcaption>
        ...
        <div class="row">
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
                        <img src="<?php echo base_url(); ?>assets/img/homepage_images/backpack.jpg" class="img-fluid" alt="#">
                        <div class="featured-title-box">
                            <h6>Herschel Camo Backpack</h6>
                            <p>$50</p>
                            <ul>
                                <li><span class="icon-location-pin"></span>
                                    <p>Pick-up in Milton, 4064</p>
                                </li>
                                <li><span class="icon-screen-smartphone"></span>
                                    <p>Login to see phone number</p>
                                </li>
            ...
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
                        <img src="<?php echo base_url(); ?>assets/img/homepage_images/coffee.jpg" class="img-fluid" alt="#">
                        <div class="featured-title-box">
                            <h6>Filter Coffee Strainer</h6>
                            <p>$20</p>
                            <ul>
                                <li><span class="icon-location-pin"></span>
                                    <p>Pick up Fortitude Valley, 4006</p>
                                </li>
                                <li><span class="icon-screen-smartphone"></span>
                                    <p>Login to see phone number</p>
                                </li>
            ...
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
                        <img src="<?php echo base_url(); ?>assets/img/homepage_images/camera.jpeg" class="img-fluid" alt="#">
                        <div class="featured-title-box">
                            <h6>Vintage Camera</h6>
                            <p>$1,000</p>
                            <ul>
                                <li><span class="icon-location-pin"></span>
                                    <p>Pick-up Nundah, 4012</p>
                                </li>
                                <li><span class="icon-screen-smartphone"></span>
                                    <p>Login to see phone number</p>
                                </li>
