...
<head>
    ...
    <!-- start: Favicon -->
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/adminfiles/img/favicon.ico">
    <!-- end: Favicon -->
...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="<?= base_url()."store_items/index"?>"><span>Bristore</span></a>
...
<!--                            <li>-->
<!--                                <a href="#">-->
<!--                                    <span class="avatar"><img src="--><?php //echo base_url(); ?><!--assets/adminfiles/img/avatar.jpg" alt="Avatar"></span>-->
<!--                                    <span class="header">-->
<!--											<span class="from">-->
<!--										    	Dennis Ji-->
<!--										     </span>-->
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="<?php echo base_url()."store_items/manage";?>"><i class="icon-edit"></i><span class="hidden-tablet">Inventory</span></a></li>
                    <!--account manage-->
                    <li><a href="<?php echo base_url()."auth/manage";?>"><i class="icon-user"></i><span class="hidden-tablet">Accounts</span></a></li>
