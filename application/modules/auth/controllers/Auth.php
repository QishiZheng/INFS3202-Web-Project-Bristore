...
//        $this->login_check();
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
                ...
                if($this->ion_auth->is_admin()) {
                    ...
                    redirect('store_items/manage', 'refresh');
                } else {
                    $this->session->set_flashdata('message', $this->ion_auth->messages());
     ...
     */
	function register(){
        $data['title'] = $this->lang->line('register_user_heading');
...
//                'address' => $this->input->post('address'),
        ...
        if ($this->form_validation->run($this) === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data))
        {
            ...
            //set flash data
            $flash_msg = "Your account has been successfully created! Hello, ".$additional_data['first_name']."!";
